...
public abstract class ProcessFunction<I, T extends TBase> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apache.thrift.ProcessFunction.class.getName());
    ...
    protected abstract boolean handleRuntimeExceptions();
