...
public class TSaslServerTransport extends TSaslTransport {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(org.apache.thrift.transport.TSaslServerTransport.class);
    ...
    public static class Factory extends TTransportFactory {
        ...
        public TTransport getTransport(TTransport base) {
            ...
            if (ret == null || ret.get() == null) {
                ...
                ret = new WeakReference<TSaslServerTransport>(new org.apache.thrift.transport.TSaslServerTransport(serverDefinitionMap, base));
                try {
                    ret.get().open();
