...
public class TZlibTransport extends TIOStreamTransport {
    ...
    public static class Factory extends TTransportFactory {
        ...
        public TTransport getTransport(TTransport base) {
            return new org.apache.thrift.transport.TZlibTransport(base);
        }
    }
    ...
    public TZlibTransport(TTransport transport, int compressionLevel) {
        ...
        inputStream_ = new InflaterInputStream(new org.apache.thrift.transport.TTransportInputStream(transport_), new Inflater());
        outputStream_ = new DeflaterOutputStream(new org.apache.thrift.transport.TTransportOutputStream(transport_), new Deflater(compressionLevel, false), true);
    }
