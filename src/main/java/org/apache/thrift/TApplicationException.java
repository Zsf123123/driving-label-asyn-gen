...
public class TApplicationException extends TException implements TSerializable {
     ...
     */
    public static org.apache.thrift.TApplicationException readFrom(TProtocol iprot) throws TException {
        org.apache.thrift.TApplicationException result = new org.apache.thrift.TApplicationException();
        result.read(iprot);
        return result;
    }
