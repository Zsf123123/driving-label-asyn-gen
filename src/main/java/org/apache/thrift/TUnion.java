...
public abstract class TUnion<T extends org.apache.thrift.TUnion<T, F>, F extends TFieldIdEnum> implements TBase<T, F> {
    ...
    protected TUnion(org.apache.thrift.TUnion<T, F> other) {
    ...
    private static class TUnionStandardScheme extends StandardScheme<TUnion> {
        ...
        @Override
        public void read(TProtocol iprot, org.apache.thrift.TUnion struct) throws TException {
        ...
        @Override
        public void write(TProtocol oprot, org.apache.thrift.TUnion struct) throws TException {
