    ...
    public class FrameBuffer {
        ...
        public void invoke() {
            ...
            try {
                ...
                inProt_.clientHostAddr = (InetSocketAddress) ((TNonblockingSocket) this.trans_).getSocketChannel().getRemoteAddress();
                inTrans_.clientHostAddr = inProt_.clientHostAddr;
