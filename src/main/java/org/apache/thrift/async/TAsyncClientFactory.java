...
public interface TAsyncClientFactory<T extends TAsyncClient> {
    ...
    class TAsyncClientManager {
        private static final Logger LOGGER = LoggerFactory.getLogger(org.apache.thrift.async.TAsyncClientManager.class.getName());
        ...
        public void call(org.apache.thrift.async.TAsyncMethodCall method) throws TException {
            if (!isRunning()) {
        ...
        private class SelectThread extends Thread {
            ...
            private void transitionMethods() {
                try {
                    ...
                    while (keys.hasNext()) {
                        ...
                        org.apache.thrift.async.TAsyncMethodCall methodCall = (org.apache.thrift.async.TAsyncMethodCall) key.attachment();
            ...
            private void timeoutMethods() {
                ...
                while (iterator.hasNext()) {
                    org.apache.thrift.async.TAsyncMethodCall methodCall = iterator.next();
            ...
            private void startPendingMethods() {
                org.apache.thrift.async.TAsyncMethodCall methodCall;
        ...
        private static class TAsyncMethodCallTimeoutComparator implements Comparator<TAsyncMethodCall>, Serializable {
            public int compare(org.apache.thrift.async.TAsyncMethodCall left, TAsyncMethodCall right) {
