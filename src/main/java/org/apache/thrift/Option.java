...
public abstract class Option<T> {
     ...
     *
     * @return true if the Option is defined (of type Some)
     ...
     */
    public static class None<T> extends org.apache.thrift.Option<T> {
     ...
     */
    public static class Some<T> extends org.apache.thrift.Option<T> {
     ...
     */
    public static <T> org.apache.thrift.Option<T> fromNullable(T value) {
        if (value != null) {
